package com.example.util.BadgeView;
...
public class BadgeView extends TextView {
	...
	private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#fffc8b35"); //Color.RED;
