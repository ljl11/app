...
public class CommonDropInterface {
	...
	public CommonDropInterface(Activity activity,ViewGroup vg,ListView list,Droping dr,Moving mo,Scrolling sc,boolean isNeedConnect) {
		this.list = list;
		this.dr = dr;
		this.mo = mo;
		this.sc =sc;
